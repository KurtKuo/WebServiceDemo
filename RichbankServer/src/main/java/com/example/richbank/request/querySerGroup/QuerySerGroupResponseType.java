...
/**
 * <p>QuerySerGroupResponseType complex type 的 Java 類別.</p>
 * 
 * <p>下列綱要片段會指定此類別中包含的預期內容.</p>
 * 
 * <pre>{@code
 * <complexType name="QuerySerGroupResponseType">
 *   <complexContent>
...
@XmlType(name = "QuerySerGroupResponseType", propOrder = {
    "code",
    "desc",
    "txSeq",
    "dateTime"
})
public class QuerySerGroupResponseType {
